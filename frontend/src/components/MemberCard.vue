  ...
  >
    ...
    <div class="ml-3 min-w-0 flex-1">
      ...
      <div v-if="!isEditing">
        ...
        <div
          v-if="member.title"
          class="text-sm text-neutral-400 mb-0.5"
        >
          {{ member.title }}
        </div>
        ...
        >
          {{ member.name }}
          <svg
            class="w-4 h-4 flex-shrink-0 opacity-70 group-hover:opacity-100 transition-opacity"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div
          v-else
          class="text-body-md font-medium text-neutral-900"
        >
          {{ member.name }}
        </div>
      </div>

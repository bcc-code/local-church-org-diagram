<template>
  <BaseDialog
    ref="baseDialog"
    :title="`${groupName} - Staber`"
    :description="dialogDescription"
  >
    <div
      v-if="staffGroups.length > 0"
      class="space-y-3"
    >
      <div
        v-for="staffGroup in staffGroups"
        :key="staffGroup.group_id"
  ...
  <GroupMembersDialog
    v-if="selectedStaffGroup"
    ref="membersDialog"
    :group-id="selectedStaffGroup.group_id"
